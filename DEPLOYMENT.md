...
sudo service unicorn_fabermetrics <start|stop|restart>
sudo service sidekiq_fabermetrics <start|stop>
```
...
```
/home/deployer/apps/fabermetrics/shared/.env.production
```

After making changes to this file, be sure to restart the application:

```
sudo service unicorn_fabermetrics restart
sudo service sidekiq_fabermetrics stop
sudo service sidekiq_fabermetrics start
```
